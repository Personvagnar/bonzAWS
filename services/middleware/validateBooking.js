import { isValidDate, isValidDateFormat, validateBookingDates } from "./validateDate.js";
...
export function validateBooking(booking) {
  ...
  if (booking.date) {
    if (!isValidDateFormat(booking.date)) {
      return { valid: false, message: "Date format is invalid, must be YYYY-MM-DD" };
    }
